            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'Powered by Llama 4 · Ask me anything!',
                    style: TextStyle(
        ...
        final confirmed = await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text(
              ...
              style:
                  const TextStyle(color: AppColors.secondaryText, fontSize: 14),
            ),
            actions: [
              TextButton(
          ...
          child: Row(
            children: [
                  ...
                  children: [
                    ...
                    Text(
                      lastMessage.isEmpty
                          ...
                          : () {
                              final senderId =
                                  room['lastMessageSenderId'] as String? ?? '';
                              ...
                              if (senderId == currentUid) {
                                ...
                                prefix = firstName[0].toUpperCase() +
              ...
              Text(
                time,
                style: TextStyle(
                  color: unread ? AppColors.primaryPurple : AppColors.hintText,
                  fontSize: 12,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final unread = _isUnread(room, currentUid);
                            final lastMessage = room['lastMessage'] ?? '';
                            final time = _formatTime(
                                room['lastMessageTime'] as Timestamp?);

                            // Use cached name — avoids flicker on stream updates
                            if (_nameCache.containsKey(otherUid)) {
                              return _buildChatTile(
                                context: context,
                                name: _nameCache[otherUid]!,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          await Navigator.pushNamed(context, SearchUserScreen.routeName);
          if (mounted) setState(() => _nameCache.clear());
        },
